...
import { MantenedorProductosComponent } from 'src/app/gestion/mantenedores/productos/productos.component';
import { ProveedoresComponent } from 'src/app/gestion/mantenedores/proveedores/proveedores.component';
import { MantenedorVentasComponent } from 'src/app/gestion/mantenedores/ventas/ventas.component';
import { OrdenesCompraComponent } from 'src/app/gestion/mantenedores/ordenes_compra/ordenes_compra.component';
import { MantenedorUsuariosComponent } from 'src/app/gestion/mantenedores/usuarios/usuarios.component';
...
export const FERME_GESTION_ROUTES: Routes = [
    ...
    { path: "ventas", component: MantenedorVentasComponent },
